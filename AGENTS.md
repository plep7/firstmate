...
The no-mistakes ship brief's born-formatted flow is the one standing exception to that sentence: there, the same worker pushes and opens the PR itself under the gate's supervision, per the flow the brief scaffolds.
